...
import type { HomeStats, TodayAppointment, UnpaidAppointment, BirthdayClient, InactiveClientHint } from './home-stats';

// ══════════════════════════════════════════════════════════════════════
// home-stats-client.ts — versión CLIENT-SIDE de getHomeStats
//
// La lógica es idéntica a home-stats.ts pero usa el cliente browser de
// Supabase (no el server). Esto permite que React Query la llame desde
// componentes 'use client' y cachee el resultado.
//
// IMPORTANTE: tipos importados de home-stats.ts (la fuente de verdad).
// Si cambias HomeStats allá, este archivo lo refleja automáticamente.
// ══════════════════════════════════════════════════════════════════════
...
export async function getHomeStatsClient(): Promise<HomeStats> {
  ...
  const isGratuito = isFreeTier(rawPlanType);
