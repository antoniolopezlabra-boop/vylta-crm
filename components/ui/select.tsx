...
// ══════════════════════════════════════════════════════════════════════
// Select — dropdown estilizado tipo shadcn/ui sobre Radix
// ══════════════════════════════════════════════════════════════════════
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    className={cn(
      ...
      'focus:outline-none focus:border-vylta-green-500/50 focus:ring-2 focus:ring-vylta-green-500/20',
  ...
  >
    <span className="absolute left-2 flex h-3.5 w-3.5 items-center justify-center">
      <SelectPrimitive.ItemIndicator>
        <Check className="h-3.5 w-3.5 text-vylta-green-600" />
      </SelectPrimitive.ItemIndicator>
    </span>
